    ...
    public void onBindViewHolder(RecipeViewHolder holder, int position) {
        ...
        mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                data.putExtra(ViewRecipeActivity.KEY_RECIPE_FIREBASE_KEY, mCursor.getString(Recipe.COL_FIREBASE_KEY));
                data.putExtra(ViewRecipeActivity.KEY_RECIPE_OFFLINE_ID, mCursor.getInt(Recipe.COL_ID));
